...
DECLARE CutoffDate DEFAULT TIMESTAMP("2021-03-08 13:50:00+00");                # UTC date, Set it to when to stop to distribute rewards
DECLARE TokenOffered DEFAULT 6680e18;                                          # Number of FLX to distribute in total
