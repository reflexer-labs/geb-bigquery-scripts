...
DECLARE StartDate DEFAULT TIMESTAMP("2021-05-08 16:00:00+00"); -- UTC date, Set it to when to start to distribute rewards
DECLARE CutoffDate DEFAULT TIMESTAMP("2021-05-25 12:50:00+00"); -- UTC date, Set it to when to stop to distribute rewards
