...
- Command `./run_incentives_query.sh ./distributions/distribution-4/queries/flx-eth-uni-v2-lp.sql exclusions.csv distributions/distribution-4/query-results/flx-eth-uni-v2-lp.csv`
