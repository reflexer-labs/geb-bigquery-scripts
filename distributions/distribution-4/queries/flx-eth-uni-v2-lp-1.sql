...
DECLARE CutoffDate DEFAULT TIMESTAMP("2021-06-21 12:50:00+00");                -- UTC date, Set it to when to stop to distribute rewards
DECLARE TokenOffered DEFAULT 160e18;                                              -- Number of FLX to distribute in total
