-- Config 
DECLARE StartDate DEFAULT TIMESTAMP("2021-10-15 12:50:00+00"); -- UTC date, Set it to when to start to distribute rewards
DECLARE CutoffDate DEFAULT TIMESTAMP("2021-10-27 12:50:00+00"); -- UTC date, Set it to when to stop to distribute rewards
...
DECLARE TokenOffered DEFAULT 360e18; -- Number of FLX to distribute in total
